...
impl Pipeline {
    pub fn new(device: Arc<Device>,
        ...
        let vertex_stage_info = Self::get_vertex_stage_info(&entry, &vshader);
        let fragment_stage_info = Self::get_fragment_stage_info(&entry, &fshader);
        ...
        let rasterization_info = Self::get_rasterization_info();
        let multisample_info = Self::get_multisample_info();
        let op_state = Self::get_stencil_op_state();
        let depth_info = Self::get_depth_info(op_state);
        let color_blend_attachment = Self::get_color_blend_attachment();
        let color_blend_info = Self::get_color_blend_info([color_blend_attachment]);
    ...
    fn get_vertex_stage_info(entry: &CString, vshader: &Shader) -> vk::PipelineShaderStageCreateInfo {
    ...
    fn get_fragment_stage_info(entry: &CString, fshader: &Shader) -> vk::PipelineShaderStageCreateInfo {
        vk::PipelineShaderStageCreateInfo {
            s_type: vk::StructureType::PIPELINE_SHADER_STAGE_CREATE_INFO,
            p_next: ptr::null(),
            flags: Default::default(),
    ...
    fn get_multisample_info() -> vk::PipelineMultisampleStateCreateInfo {
    ...
    fn get_color_blend_attachment() -> vk::PipelineColorBlendAttachmentState {
    ...
    fn get_color_blend_info(color_blend_attachment: [vk::PipelineColorBlendAttachmentState; 1]) -> vk::PipelineColorBlendStateCreateInfo {
    ...
    fn get_stencil_op_state() -> vk::StencilOpState {
        vk::StencilOpState {
    ...
    fn get_depth_info(op_state: vk::StencilOpState) -> vk::PipelineDepthStencilStateCreateInfo {
